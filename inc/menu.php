...
register_nav_menus(
	array(
		'main-nav'		=> __( 'The Main Menu', 'nurturant' ),		// Main nav in header
		'offcanvas-nav'	=> __( 'The Off-Canvas Menu', 'nurturant' ),	// Off-Canvas nav
		'footer-links'	=> __( 'Footer Links', 'nurturant' ),		// Secondary nav in footer
		'social-links'	=> __( 'Social Links', 'nurturant' ),		// Social Nav
	)
);


// The Top Menu
function nurturant_top_nav() {
	wp_nav_menu(array(
...
// The Off Canvas Menu
function nurturant_off_canvas_nav() {
	wp_nav_menu(array(
		'container'			=> false,							// Remove nav container
...
// The Footer Menu
function nurturant_footer_links() {
	wp_nav_menu(array(
		'container'			=> 'false',				// Remove nav container
...
function nurturant_footer_links_fallback() {
