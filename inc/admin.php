...
function nurturant_custom_admin_footer() {
// 	_e('<span id="footer-thankyou">Developed by <a href="https://proprdesign.com/" target="_blank">Propr Design</a></span>.', 'nurturant');
}

// adding it to the admin area
add_filter('admin_footer_text', 'nurturant_custom_admin_footer');
